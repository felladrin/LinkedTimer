              ...
              <Card.Section withBorder inheritPadding py="xs">
                <Group position="apart">
                  ...
                  <Menu withinPortal position="bottom-end" shadow="sm">
                    ...
                    <Menu.Dropdown>
                      <Menu.Item icon={colorScheme === "dark" ? <IconSun size={14} /> : <IconMoonStars size={14} />} onClick={() => toggleColorScheme()}>
                        Toggle Color Scheme
                      </Menu.Item>
                      <Menu.Item icon={<IconExternalLink size={14} />} component="a"
                                 target="_blank"
